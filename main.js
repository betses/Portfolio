...
const myProjects = [
  ...
  },
  {
    id: 6,
    name: 'Bookstore',
    title: 'Bookstore: Effortlessly Manage Your Books with JavaScript Classes and Local Storage',
    image: 'image/bookstore.PNG',
    technologies: ['HTML', 'CSS', 'JavaScript'],
    description: 'Bookstore is a front-end application that utilizes JavaScript classes and modules to perform various functions such as adding books, deleting books, displaying a list of books, and managing all activities on Local Storage. It also integrates Luxon library to display the current time. The application utilizes the power of JavaScript classes and modules to make the process of managing books seamless and easy to use. It is an ideal solution for anyone looking to keep track of their books and manage them efficiently. The application’s use of Luxon library also adds a unique touch of real-time functionality to the project.',
  ...
  },
  {
    ...
    description: 'Dota 2 Webapp is a mobile web application built using React and Redux, that allows users to easily check and browse the list of items and heroes in the popular game Dota 2. The application\'s user- friendly interface and integration with React and Redux makes it a powerful tool for Dota 2 players to access and explore the game\'s various items and heroes on the go. The application\'s focus on providing information on items and heroes in a concise and organized manner, makes it an ideal solution for Dota 2 players looking to stay up - to - date on the game\'s content.',
